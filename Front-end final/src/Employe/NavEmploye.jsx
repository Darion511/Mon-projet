        ...
        <div className="collapse navbar-collapse d-sm-flex justify-content-center" id="navbarNav">
          <ul className="navbar-nav">
            <li className="nav-item">
              <a a className="nav-link" href="#"style={{fontFamily:'Imprint MT Shadow'}} onClick={VersAccueilE}>Accueil</a> 
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#"style={{fontFamily:'Imprint MT Shadow'}} onClick={VersCR}>Commande</a> 
            </li>
            <li className="nav-item">
              <a a className="nav-link" href="#"style={{fontFamily:'Imprint MT Shadow'}} onClick={VersE}>Menu</a> 
            </li>
            <li className="nav-item">
              <a a className="nav-link" href="#"style={{fontFamily:'Imprint MT Shadow'}} onClick={VersR}>Reclamations</a> 
            </li>
          </ul>
        </div>
